...
function setupFileLoaders() {
    ...
    document.getElementById('button-open').addEventListener('click', function (ev) {
...
function loadTextSettingsMenu(settings) {
...
function showTrnInSpotlight(i) {
    ...
    const spotlightElem = document.getElementById('spotlight');
...
function trnLangClickHandler(ev) {
    const trnLangOrder = globals.settings.trnLangOrder;
    const liElem = ev.target;
    ...
    liElem.previousElementSibling.dataset.rank = '' + rank;
...
function setupMenuListeners() {
    ...
    voiceSpeedElem.addEventListener('input', (ev) => {
        const voiceSpeedText = ev.currentTarget.value;
    ...
    textSizeElem.addEventListener('input', (ev) => {
        const textSizeText = ev.currentTarget.value;
